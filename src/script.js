...
function CreateToDoItems() {
    if (todoValue.value === "") {
      ...
      // if (IsPresent) {
      //   setAlertMessage("Эта задача уже находиться в списке!");
      //   return;
      // }
...
function ReadToDoItems() {
  todo.forEach((element) => {
    ...
    ${
      style === ""
        ? ""
        : '<img class="todo-controls" src="img/refresh.png" />'
    }</div><div>
    ${
      style === ""
        ? '<img class="edit todo-controls" onclick="UpdateToDoItems(this)" src="img/edit.png" />'
...
function UpdateToDoItems(e) {
  ...
  function UpdateOnSelectionItems() {
    ...
    todoValue.value = "";
    // setAlertMessage("Задача успешно обновилась!");
  }
  ...
  function CompletedToDoItems(e) {
    if (e.parentElement.querySelector("div").style.textDecoration === "") {
      ...
      setLocalStorage();
      // setAlertMessage("Задача успешно выполнена!");
    }
  }
